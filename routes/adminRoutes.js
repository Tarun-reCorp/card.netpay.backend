...
router.post('/merchants',                   requireRole('ops'), merchantCtrl.uploadMerchantImages, merchantCtrl.createMerchant);
router.put('/merchants/:id',                requireRole('ops'), merchantCtrl.uploadMerchantImages, merchantCtrl.updateMerchant);
